...
class content_model extends model {
	...
	public function add_content($data,$isimport = 0) {
		...
		if(!defined('IN_ADMIN') || $data['status']!=99) {
			...
			$check_data = array(
                ...
                /*'shop_prize'=>$systeminfo['shop_prize'],
                'shop_detail'=>$systeminfo['shop_detail'],
                'shop_size'=>$systeminfo['shop_size'],
                'shop_color'=>$systeminfo['shop_color'],*/
				'status'=>$data['status'],
				);
				...
				if($modelid==$mid) {
					...
					if($data['status']!=99) {
						$check_data = array(
                            ...
                            'shop_prize'=>$systeminfo['shop_prize'],
                            'shop_detail'=>$systeminfo['shop_detail'],
                            'shop_freight'=>$systeminfo['shop_freight'],
                            'shop_size'=>$systeminfo['shop_size'],
                            'shop_color'=>$systeminfo['shop_color'],
                            'shop_data'=>$modelinfo['shop_data'],
                            'shop_fare'=>$modelinfo['shop_fare'],
                            'shop_from'=>$modelinfo['shop_from'],
                            'shop_total'=>$modelinfo['shop_total'],
                            'buyer_data'=>$modelinfo['buyer_data'],
                            'geter_data'=>$modelinfo['geter_data'],
                            'eqno'=>$modelinfo['eqno'],
                            'buy_prize'=>$modelinfo['buy_prize'],
                            'buy_freight'=>$modelinfo['buy_freight'],
                            'buy_totalnum'=>$modelinfo['buy_totalnum'],
							'status'=>1,
							);
						$this->content_check_db->insert($check_data);
					}
	 ...
	 * @param $catid 栏目id
	 */
	public function delete_content_orderlist($id){
        //删除主表数据
