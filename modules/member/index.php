...
class index extends foreground {
	...
	public function init() {
        ...
        $contentpage = pc_base::load_app_class('content_tag','content');
	...
	public function register() {
		...
		if(isset($_POST['dosubmit'])) {
			...
			$userinfo['tel'] = $_POST['tel'];
			$userinfo['address'] = $_POST['address'];
			$userinfo['cityname'] = $_POST['cityname'];
			$userinfo['conturyname'] = $_POST['conturyname'];
			$userinfo['finishaddress'] = $_POST['finishaddress'];
	...
	public function codecheck(){
		...
		if(isset($_POST['dosubmit'])) {
            if(empty($_SESSION['connectid'])) {
                ...
                $_SESSION['code'] = '';
                alert::message(1,'success');
            }
        }else{


            $cat_list = form::checkcode2('code_img', '5', '14', 120, 26);
            alert::message(1,'',$cat_list);
	...
	public function logout() {
		...
		if($setting['snda_enable'] && param::get_cookie('_from')=='snda') {
			...
			if($type){
				alert::message(1,L('logout_success'));
			}else{
