...
class content_input {
	...
	function get($data,$isimport = 0) {
		...
		foreach($data as $field=>$value) {
            ...
            if($this->fields[$field]['issystem'] or $field=='shop_prize' or $field=='shop_detail' or $field=='shop_freight' or $field=='shop_size' or $field=='shop_color' or $field=='shop_data' or $field=='shop_fare' or $field=='shop_from' or $field=='shop_total' or $field=='buyer_data' or $field=='geter_data' or $field=='eqno' or $field=='buy_prize' or $field=='buy_freight' or $field=='buy_totalnum' or $field=='fivenumber' or $field=='sendtime' or $field=='finishmoney') {
                $newvalue=$value;
                if($field=='shop_detail' or $field=='shop_size' or $field=='shop_color'){
                    $newvalue=json_encode($value, JSON_UNESCAPED_UNICODE);
                }
                $info['system'][$field] = $newvalue;
            } else {
