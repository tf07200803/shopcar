...
<script language="javascript" type="text/javascript" src="<?php echo JS_PATH?>main.js"></script>
...
<table width="100%" cellspacing="0" class="table_form">
    ...
    <tr>
        ...
        <th width="80">單價</th>
        <td><input type="number" id="shop_prize" name="info[shop_prize]" value="<?php echo $forminfos['base']['catid']['shop_prize'];?>"/> </td>
    ...
    <tr>
        ...
        <th width="80">細項分類</th>
        <td><div id="shop_detail"></div></td>

    </tr>
    <tr>

        <th width="80">尺寸分類</th>
        <td><div id="shop_size"></div></td>

    </tr>
    <tr>

        <th width="80">顏色分類</th>
        <td><div id="shop_color"></div></td>

    </tr>
    <tr>

        <th width="80">照片上傳</th>
        <td><input type="button" value="照片上傳" onclick="uploadbtnclick()"/> </td>
...
<!--
//只能放到最下面
var detailArray={"shop_detail":new Array(""),"shop_size":new Array(""),"shop_color":new Array("")}

var shop_detail=<?php echo $forminfos['base']['catid']['shop_detail'];?>;
var shop_size=<?php echo $forminfos['base']['catid']['shop_size'];?>;
var shop_color=<?php echo $forminfos['base']['catid']['shop_color'];?>;

if(shop_detail.length>0){
    detailArray['shop_detail']=shop_detail
}
if(shop_size.length>0){
    detailArray['shop_size']=shop_size
}
if(shop_color.length>0){
    detailArray['shop_color']=shop_color
}
